 ...
 )
{
    ...
    if (sizeof(BlockHeader) > m_dataSize) {
        maxHeaderData = sizeof(BlockHeader);
    } else {
        maxHeaderData = m_dataSize;
    }
//    unsigned maxHeaderData = Max(sizeof(BlockHeader), m_dataSize);
